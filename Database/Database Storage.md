...
Random Access on disk is slower than sequential Access, so the DBMS will want to maximise sequential access.
...
![[Pasted image 20240818134944.png]]
...
This will allow my process to touch it or perform other operations once. Similarly, if i try to access page two and three and it isn't there. I will encounter a page fault because the OS will block my process and update the wiring. Only then will my thread be able to resume and my process will be able to resume.

**What happens when I want to touch page four? What happens during the process of getting rid of it?**
